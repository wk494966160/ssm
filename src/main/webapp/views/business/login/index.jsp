...
<script src="../../../static/js/main.js"></script>
        ...
        <div class="container">
            <div class="navbar-header">
                ...
                <div class="site-branding">
                    <a class="logo" href="">
                        <!-- logo image  -->
                        <img src="../../../static/images/html/logo.png" alt="Logo">
                        标题
                    </a>
                </div>
            ...
            <div class="collapse navbar-collapse" id="navbar-items">
                <ul class="nav navbar-nav navbar-right">
                    ...
                    <li><a data-scroll href="#speakers">演讲者</a></li>
                    <li><a data-scroll href="#schedule">时间表</a></li>
                    <li><a data-scroll href="#partner">合作伙伴</a></li>
                    <li><a data-scroll href="#faq">常见问题</a></li>
                    <li><a data-scroll href="#photos">相片</a></li>
    ...
    <header id="site-header" class="site-header valign-center"> 
        <div class="intro">
            ...
            <h2>2015年4月25日/ TOWNHALL CALIFORNIA</h2>
            
            <h1>2015年自由职业者大会</h1>
            
            <p>第一次和最大的会议</p>
            
            <a class="btn btn-white" data-scroll href="#registration">注册</a>
        ...
        <div class="container">
            <div class="row">
                <div class="col-sm-6">
                    ...
                    <figure>
                        <img alt="" class="img-responsive" src="../../../static/images/html/about-us.jpg">
                    </figure>
...
<div class="copyrights">Collect from <a href="http://www.cssmoban.com/" >手机网站模板</a></div>
            ...
            <div class="row">
                <div class="col-md-4">
                    <div class="speaker">
                        ...
                        <figure>
                            <img alt="" class="img-responsive center-block" src="../../../static/images/html/speakers/speaker-1.jpg">
                        </figure>
                ...
                <div class="col-md-4">
                    <div class="speaker">
                        ...
                        <figure>
                            <img alt="" class="img-responsive center-block" src="../../../static/images/html/speakers/speaker-2.jpg">
                        </figure>
                ...
                <div class="col-md-4">
                    <div class="speaker">
                        ...
                        <figure>
                            <img alt="" class="img-responsive center-block" src="../../../static/images/html/speakers/speaker-3.jpg">
                        </figure>
            ...
            <div class="row">
                <div class="col-md-4">
                    ...
                    <div class="speaker">
                        ...
                        <figure>
                            <img alt="" class="img-responsive center-block" src="../../../static/images/html/speakers/speaker-4.jpg">
                        </figure>
                ...
                <div class="col-md-4">
                    ...
                    <div class="speaker">
                        ...
                        <figure>
                            <img alt="" class="img-responsive center-block" src="../../../static/images/html/speakers/speaker-5.jpg">
                        </figure>
                ...
                <div class="col-md-4">
                    <div class="speaker">
                        <figure>
                            <img alt="" class="img-responsive center-block" src="../../../static/images/html/speakers/speaker-6.jpg">
                        </figure>
                        <h4>Jhon Smith</h4>
                        <p>CEO of Peren</p>
                        <ul class="social-block">
                ...
                <div class="col-md-12">
                    <ul class="grid">
                        ...
                        <li class="grid-item grid-item-sm-6">
                            <img alt="" class="img-responsive center-block" src="../../../static/images/html/photos/photos-1.jpg">
                        </li>

                        <li class="grid-item grid-item-sm-3">
                            <img alt="" class="img-responsive center-block" src="../../../static/images/html/photos/photos-2.jpg">
                        </li>

                        <li class="grid-item grid-item-sm-3">
                            <img alt="" class="img-responsive center-block" src="../../../static/images/html/photos/photos-3.jpg">
                        </li>
                    
                        <li class="grid-item grid-item-sm-3">
                            <img alt="" class="img-responsive center-block" src="../../../static/images/html/photos/photos-5.jpg">
                        </li>

                        <li class="grid-item grid-item-sm-3">
                            <img alt="" class="img-responsive center-block" src="../../../static/images/html/photos/photos-6.jpg">
                        </li>

                        <li class="grid-item grid-item-sm-3">
                            <img alt="" class="img-responsive center-block" src="../../../static/images/html/photos/photos-7.jpg">
                        </li>

                        <li class="grid-item grid-item-sm-3">
                            <img alt="" class="img-responsive center-block" src="../../../static/images/html/photos/photos-8.jpg">
                        </li>
    ...
    <footer class="site-footer">
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <p class="site-info">More Templates <a href="http://www.cssmoban.com/" target="_blank" title="模板之家">模板之家</a> - Collect from <a href="http://www.cssmoban.com/" title="网页模板" target="_blank">网页模板</a></p>
                    <ul class="social-block">
                        <li><a href=""><i class="ion-social-twitter"></i></a></li>
                        <li><a href=""><i class="ion-social-facebook"></i></a></li>
                        <li><a href=""><i class="ion-social-linkedin-outline"></i></a></li>
